...
const HITTING_BENCHMARKS_BY_LEVEL = {
  ...
  A:    { EV_AVG:{range:[82.0,88.0],p50:85.5}, EV_MAX:{range:[102.0,110.0],p50:106.5}, HARD_HIT_PCT:{range:[29.0,39.0],p50:33.0}, LA_AVG:{range:[5.0,15.0],p50:9.0}, CONTACT_PCT:{range:[72.0,80.0],p50:75.0}, ZCONTACT_PCT:{range:[82.0,90.0],p50:86.0}, WHIFF_PCT:{range:[22.0,30.0],p50:26.0}, CHASE_PCT:{range:[22.0,30.0],p50:28.0}, BB_GB_PCT:{range:[36.0,50.0],p50:42.0}, BB_LD_PCT:{range:[18.0,26.0],p50:22.0}, BB_FB_PCT:{range:[30.0,40.0],p50:34.0}, BB_PU_PCT:{range:[6.0,10.0],p50:8.0}, BARREL_PCT:{range:[6.0,12.0],p50:8.0} },
};
